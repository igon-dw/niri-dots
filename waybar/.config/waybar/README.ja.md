...
@define-color appmenu_hover_bg; /* アプリメニューホバー背景 */
```
...
@define-color cpu_bg                 /* CPU背景 */
@define-color cpu_hover_bg           /* CPUホバー背景 */
@define-color temperature_fg         /* 温度文字色 */
@define-color temperature_bg         /* 温度背景 */
@define-color temperature_hover_bg   /* 温度ホバー背景 */
@define-color disk_fg                /* ディスク文字色 */
@define-color disk_bg                /* ディスク背景 */
@define-color disk_hover_bg          /* ディスクホバー背景 */
@define-color gpu_fg                 /* GPU文字色 */
@define-color gpu_bg                 /* GPU背景 */
@define-color gpu_hover_bg           /* GPUホバー背景 */
@define-color memory_fg              /* メモリ文字色 */
@define-color memory_bg              /* メモリ背景 */
@define-color memory_hover_bg; /* メモリホバー背景 */
```
...
@define-color clock_bg               /* 時計背景 */
@define-color clock_hover_bg         /* 時計ホバー背景 */
@define-color workspaces_bg          /* ワークスペース背景 */
@define-color workspaces_border; /* ワークスペース枠線 */
```

#### システムトレイ

```css
@define-color tray_bg                /* トレイ背景 */
@define-color tray_hover_bg          /* トレイホバー背景 */
...
@define-color logout_bg              /* ログアウト背景 */
@define-color logout_hover_bg; /* ログアウトホバー背景 */
```
...
@define-color theme_bg               /* テーマボタン背景 */
@define-color theme_hover_bg; /* テーマボタンホバー背景 */
```

#### Mako通知消去ボタン

```css
@define-color makodismiss_bg         /* 通知消去ボタン背景 */
@define-color makodismiss_border     /* 通知消去ボタン枠線 */
@define-color makodismiss_hover_bg; /* 通知消去ボタンホバー背景 */
```

#### 言語切り替え

```css
@define-color language_bg            /* 言語表示背景 */
@define-color language_hover_bg; /* 言語表示ホバー背景 */
```

#### 音量コントロール

```css
@define-color pulseaudio_bg          /* 音量背景 */
@define-color pulseaudio_hover_bg; /* 音量ホバー背景 */
```
...
@define-color mpris_bg               /* MPRIS背景 */
@define-color mpris_hover_bg; /* MPRISホバー背景 */
```
