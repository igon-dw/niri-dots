return {
  ...
  opts = {
    ...
    indent = { enabled = true },
    -- Enable input UI (replaces vim.ui.input)
    input = { enabled = true },
    ...
    scroll = { enabled = true },
    -- Enable status column improvements
  ...
  keys = {
    ...
    },
    {
      '<leader>uC',
      function()
        Snacks.picker.colorschemes { pattern = vim.g.colors_name }
      end,
      desc = 'Colorschemes',
    },
